#!/usr/bin/python3
#-*-coding:utf-8-*-
# Made With ❤️ By Nazir KhaN aND AjMaL SHaH Project
# Update V0.1
...
# Author : AjMaL SHAH
# Facebook (NaZir KhaN)   : https://www.facebook.com/NaZerkhaN521
# Instagram (☬ 𝐀𝐧𝐨𝐧𝐲𝐦 𝟒𝟎𝟒 ☬)    : Instagram.com/ratya.anonym.id
# Whatsapp (911 we DAILE)      : +923025669420
# Facebook (.ID)           : https://www.facebook.com/NaZerkhaN521
...
_logo_line_3_ = ('%s #  # # #     %s│   %s• Code By Nazir •   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s ## ### #     %s│ %sGithub.com/nazir003 %s│'%(_P_,_U_,_P_,_U_))
